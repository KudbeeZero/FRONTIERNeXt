...
const TOWED: WeaponSpec[] = [
  {
    ...
    damage: 45, splashRadius: 0.5, cooldownMs: 90_000, costFrntr: 4,
  ...
  },
  {
    ...
    damage: 70, splashRadius: 0.7, cooldownMs: 120_000, costFrntr: 7,
    attributeAffinity: "logistics", unlock: { badge: "long_rifle", tier: "none" },
  },
  {
    ...
    payloadKg: 43, cepM: 5,
    damage: 90, splashRadius: 0.7, cooldownMs: 130_000, costFrntr: 12,
  ...
  },
  {
    ...
    damage: 110, splashRadius: 0.8, cooldownMs: 150_000, costFrntr: 18,
...
const ROCKET: WeaponSpec[] = [
  {
    ...
    damage: 95, splashRadius: 1.2, cooldownMs: 180_000, costFrntr: 14,
  ...
  },
  {
    ...
    payloadKg: 90, cepM: 5,
    damage: 130, splashRadius: 1.1, cooldownMs: 210_000, costFrntr: 24,
  ...
  },
  {
    ...
    payloadKg: 90, cepM: 5,
    damage: 160, splashRadius: 1.2, cooldownMs: 230_000, costFrntr: 36,
    attributeAffinity: "range", unlock: { badge: "long_rifle", tier: "silver" },
  },
  {
    ...
    payloadKg: 90, cepM: 5,
    damage: 200, splashRadius: 1.3, cooldownMs: 260_000, costFrntr: 54,
...
const MLRS: WeaponSpec[] = [
  {
    ...
    damage: 175, splashRadius: 1.6, cooldownMs: 300_000, costFrntr: 40,
  ...
  },
  {
    ...
    damage: 215, splashRadius: 1.7, cooldownMs: 330_000, costFrntr: 60,
    attributeAffinity: "firepower", unlock: { badge: "long_rifle", tier: "gold" },
  },
  {
    ...
    damage: 255, splashRadius: 1.8, cooldownMs: 360_000, costFrntr: 82,
  ...
  },
  {
    ...
    damage: 300, splashRadius: 2.0, cooldownMs: 400_000, costFrntr: 110,
    attributeAffinity: "firepower", unlock: { badge: "long_rifle", tier: "hall_of_fame" },
  },
];
