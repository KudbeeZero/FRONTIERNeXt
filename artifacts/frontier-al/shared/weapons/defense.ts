...
export const DEFENSE_SYSTEMS: WeaponSpec[] = [
  {
    ...
    payloadKg: 11, cepM: 1,
    damage: 80, splashRadius: 0.4, cooldownMs: 20_000, costFrntr: 30,
  ...
  },
  {
    ...
    damage: 50, splashRadius: 0.2, cooldownMs: 8_000, costFrntr: 18,
  ...
  },
  {
    ...
    damage: 180, splashRadius: 0.5, cooldownMs: 40_000, costFrntr: 70,
  ...
  },
  {
    ...
    damage: 230, splashRadius: 0.6, cooldownMs: 60_000, costFrntr: 110,
  ...
  },
  {
    ...
    damage: 250, splashRadius: 0.6, cooldownMs: 70_000, costFrntr: 140,
    attributeAffinity: "interception", unlock: { badge: "aegis", tier: "gold" },
  ...
  },
  {
    ...
    damage: 300, splashRadius: 0.8, cooldownMs: 90_000, costFrntr: 200,
