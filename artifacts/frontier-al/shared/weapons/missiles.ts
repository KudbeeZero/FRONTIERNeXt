...
const BALLISTIC: WeaponSpec[] = [
  {
    ...
    damage: 120, splashRadius: 1.0, cooldownMs: 25 * 60_000, costFrntr: 18,
  ...
  },
  {
    ...
    damage: 165, splashRadius: 1.1, cooldownMs: 28 * 60_000, costFrntr: 30,
  ...
  },
  {
    ...
    damage: 230, splashRadius: 1.3, cooldownMs: 32 * 60_000, costFrntr: 48,
  ...
  },
  {
    ...
    damage: 300, splashRadius: 1.5, cooldownMs: 36 * 60_000, costFrntr: 70,
...
const CRUISE: WeaponSpec[] = [
  {
    ...
    damage: 130, splashRadius: 0.9, cooldownMs: 30 * 60_000, costFrntr: 26,
  ...
  },
  {
    ...
    damage: 160, splashRadius: 1.0, cooldownMs: 30 * 60_000, costFrntr: 38,
  ...
  },
  {
    ...
    damage: 185, splashRadius: 1.0, cooldownMs: 32 * 60_000, costFrntr: 52,
  ...
  },
  {
    ...
    damage: 215, splashRadius: 1.1, cooldownMs: 34 * 60_000, costFrntr: 74,
...
const HYPERSONIC: WeaponSpec[] = [
  {
    ...
    payloadKg: 480, cepM: 30,
    damage: 260, splashRadius: 1.3, cooldownMs: 40 * 60_000, costFrntr: 90,
    attributeAffinity: "firepower", unlock: { badge: "demolition", tier: "silver" },
  },
  {
    ...
    damage: 320, splashRadius: 1.4, cooldownMs: 44 * 60_000, costFrntr: 120,
    attributeAffinity: "firepower", unlock: { badge: "demolition", tier: "gold" },
  },
  {
    ...
    damage: 380, splashRadius: 1.6, cooldownMs: 48 * 60_000, costFrntr: 165,
    attributeAffinity: "firepower", unlock: { badge: "demolition", tier: "gold" },
  },
  {
    ...
    damage: 460, splashRadius: 1.9, cooldownMs: 55 * 60_000, costFrntr: 230,
