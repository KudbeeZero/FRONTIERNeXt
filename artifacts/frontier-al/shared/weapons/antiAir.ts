...
export const ANTI_AIR: WeaponSpec[] = [
  {
    ...
    payloadKg: 3, cepM: 1,
    damage: 60, splashRadius: 0.3, cooldownMs: 45_000, costAscend: 8,
  ...
  },
  {
    ...
    payloadKg: 23, cepM: 1,
    damage: 95, splashRadius: 0.4, cooldownMs: 60_000, costAscend: 16,
  ...
  },
  {
    ...
    payloadKg: 23, cepM: 1,
    damage: 110, splashRadius: 0.4, cooldownMs: 70_000, costAscend: 22,
  ...
  },
  {
    ...
    payloadKg: 90, cepM: 2,
    damage: 140, splashRadius: 0.5, cooldownMs: 90_000, costAscend: 38,
    attributeAffinity: "interception", unlock: { badge: "aegis", tier: "silver" },
  ...
  },
  {
    ...
    damage: 170, splashRadius: 0.5, cooldownMs: 100_000, costAscend: 56,
  ...
  },
  {
    ...
    damage: 200, splashRadius: 0.6, cooldownMs: 110_000, costAscend: 78,
    attributeAffinity: "interception", unlock: { badge: "aegis", tier: "gold" },
  ...
  },
  {
    ...
    damage: 240, splashRadius: 0.6, cooldownMs: 130_000, costAscend: 104,
  ...
  },
  {
    ...
    damage: 260, splashRadius: 0.7, cooldownMs: 140_000, costAscend: 130,
    attributeAffinity: "interception", unlock: { badge: "aegis", tier: "hall_of_fame" },
