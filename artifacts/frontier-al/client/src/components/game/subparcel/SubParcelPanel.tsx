...
import { SUB_PARCEL_HOLD_HOURS, IMPROVEMENT_INFO } from "@shared/schema";
import { SubdivisionCountdown } from "./SubdivisionCountdown";
import { SubParcelDetail } from "./SubParcelDetail";

interface SubParcelPanelProps {
  parcel: LandParcel;
  player: Player | null;
  onNavigate?: () => void;
}

export function SubParcelPanel({ parcel, player, onNavigate }: SubParcelPanelProps) {
