    ...
    <div style={{ position: "absolute", left: 12, bottom: 24, zIndex: 30 }}>
      {open && (
        ...
        >
          ...
          <label style={{ display: "flex", alignItems: "center", justifyContent: "space-between", margin: "0 0 10px", cursor: "pointer" }}>
            <span style={{ fontSize: 11, color: "rgba(180,210,255,0.8)" }} title="Gently pan the camera to follow your own battles as they resolve">Cinematic Camera</span>
            <input
              type="checkbox"
              checked={prefs.cinematicCamera}
              onChange={(e) => setVisualPref("cinematicCamera", e.target.checked)}
