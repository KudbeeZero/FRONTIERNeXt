...
import { biomeColors, DEFENSE_IMPROVEMENT_INFO, FACILITY_INFO, IMPROVEMENT_INFO, SUB_PARCEL_FACILITY_COSTS, SUB_PARCEL_DEFENSE_COSTS, getBiomeUpgradeMultiplier, ARCHETYPE_FACTION_BONUSES, isImprovementAllowedForArchetype } from "@shared/schema";
import { ARCHETYPE_LABELS, ARCHETYPE_DESCS, FORTRESS_TIERS, ENERGY_ALIGNMENTS } from "./constants";

export function SubParcelUpgradePanel({ sp, player, parentPlotId, biome, onClose }: {
  sp: SubParcel;
  player: Player;
  parentPlotId: number;
  biome: BiomeType;
