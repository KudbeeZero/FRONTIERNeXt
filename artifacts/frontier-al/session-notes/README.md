...
- [2026-06-14-idempotency-stable-nonce](./2026-06-14-idempotency-stable-nonce.md) — Stable idempotency nonce (PR #29, ID-003+001+002): two-phase claim/record/release → duplicate replays original 200 (not 409), in-flight→409, failed→release; +safeUuid, escaped target; guard spec rewritten (23 cases) + safeUuid spec; /security-pass PASS; #27 audited PASS + merged
