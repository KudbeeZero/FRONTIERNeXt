...
- [2026-06-08-web-session-start-hook](./2026-06-08-web-session-start-hook.md) — Web SessionStart hook auto-installs pnpm deps (fixes fresh-container TS2688); detailed dev-environment memory doc + fragility map
