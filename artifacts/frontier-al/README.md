...
```
   .    *      .       ✦        .         *       .      .     ✦
       ◍ ─────────  F R O N T I E R - A L  ·  v1.5.0  ───────── ◍
   *       .     a persistent frontier on the Algorand chain      .
        .      *          .            .         *        .
```

# 🛰️ FRONTIER-AL — Game Hub

**A persistent globe-based strategy game powered by the Algorand blockchain.**

<!-- ── NAV ─────────────────────────────────────────────────────────── -->
<a href="GETTING_STARTED.md"><img src="https://img.shields.io/badge/🚀_Getting_Started-Launch-00E5FF?style=for-the-badge&labelColor=0B0E2A" alt="Getting Started"></a>
...
| | Guide | Description |
|---|---|---|
| 🚀 | **[Getting Started](GETTING_STARTED.md)** | Five-step launch sequence — connect a wallet, opt in, claim your bonus, and plant your first flag |
| 📖 | **[Game Manual](GAME_MANUAL.md)** | Complete guide to every game system, mechanic, and feature — rare minerals, loot boxes, landmarks, and seasons |
...
> The complete player manual — first login through advanced endgame strategy,
> covering biomes, mining, building, the FRONTIER economy, combat, Commanders,
> special attacks, drones, satellites, AI factions, orbital events, and seasons —
> now lives in its own document so this README can stay a clean hub.

<div align="center">
<a href="GAME_MANUAL.md"><img src="https://img.shields.io/badge/📖_Open_the_Game_Manual-2D7FF9?style=for-the-badge&labelColor=0B0E2A" alt="Open the Game Manual"></a>
<a href="GETTING_STARTED.md"><img src="https://img.shields.io/badge/🚀_New_here_·_Getting_Started-00E5FF?style=for-the-badge&labelColor=0B0E2A" alt="Getting Started"></a>
</div>
