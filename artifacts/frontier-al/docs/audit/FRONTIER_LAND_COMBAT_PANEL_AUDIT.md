...
**Originally audited at commit:** `fa5b125` (main, PR #242 merged)
**Recovered onto `main` at:** `e5b423b` (2026-07-12) — re-verified against current `main`; the combat/panel code is unchanged by PR #243 (cost-control), #244, or #245 (documentation only).
